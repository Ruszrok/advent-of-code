...
func TestIsValidRope(t *testing.T) {
	tests := []struct {
		...
		{[2]int{0, 1}, [2]int{1, 1}, true},
		{[2]int{0, 1}, [2]int{0, 0}, true},
		{[2]int{0, 0}, [2]int{1, 1}, true},
		{[2]int{1, 1}, [2]int{0, 0}, true},
		{[2]int{2, 0}, [2]int{1, 1}, true},
		{[2]int{0, 2}, [2]int{1, 1}, true},
...
func TestIsValidOneTimeMoveInMultiKnotRope(t *testing.T) {
	tests := []struct {
		...
		{[]Coords{{2, 8}, {3, 8}, {4, 7}, {4, 6}, {4, 5}, {4, 4}, {3, 3}}, "L", []Coords{{1, 8}, {2, 8}, {3, 8}, {3, 7}, {3, 6}, {3, 5}, {3, 4}}},
	}
